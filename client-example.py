...
if __name__ == "__main__":
    ...
    try:
        ...
        print("---------------------------------------")
        print("Informazioni nodo OPC UA")
        ...
        print("---------------------------------------")
        print("Informazioni sul nodo conoscendo il suo node id: 1be5ba38-d004-46bd-aa3a-b5b87940c698")
        #var = client.get_node(ua.NodeId(1002, 2))
        #var = client.get_node("ns=3;i=2002")
        #var = client.get_node("ns=2;g=1be5ba38-d004-46bd-aa3a-b5b87940c698")
        #print(var)
        
        #out1 = var.get_data_value() # get value of node as a DataValue object
        #out2 = var.get_value() # get value of node as a python builtin
        ...
        print("---------------------------------------")
        print("Chiamare un metodo all'interno del server")
        '''print("Questo puo essere fatto usando: obj.call_method("{}:multiply".format(idx), 3,)")'''
        res1 = obj.call_method("{}:multiply".format(idx), 3, "klk")
        print("method result is: ", res1)
